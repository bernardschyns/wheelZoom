...
//        debugger;
        ...
        main = function(img, options) {
                ...
                canvasTravail.width = img.naturalWidth;
				canvasTravail.height = img.naturalHeight;
//                img.src = canvasTravail.toDataURL();
                var monRatio=monContext.canvas.clientWidth/img.naturalWidth;
                monContext.drawImage(img, 0, 0,img.naturalWidth,img.naturalHeight,0,0,monRatio*img.naturalWidth,monRatio*img.naturalHeight);
...
//                        img.style.backgroundPosition = bgPosX + 'px ' + bgPosY + 'px';
						var img = settings.image;
						  monContext.drawImage(img, 0, 0,img.naturalWidth/2,img.naturalHeight/2,0,0,monRatio*img.naturalWidth,monRatio*img.naturalHeight);
